...
# License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl).
{
    ...
    "depends": ["base_territory", "base_geolocalize", "resource", "contacts", "gulfco_customer_customized_data", "stock",
                "gulfco_vendor_customized_data", "account", "fleet", "resource", "gulfco_contact_registration_custom"],
    "data": [
        ...
        "data/fsm_stage.xml",
        "data/fsm_team.xml",
        "data/route_status_crone_job.xml",
