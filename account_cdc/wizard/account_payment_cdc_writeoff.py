...
class AccountPaymentCdcWriteoff(models.TransientModel):
    _name = 'account.payment.cdc.writeoff'
    _description = 'Account Payment CDC Write Off Wizard'
    ...
    def action_register_write_off(self):
        ...
        if payment.is_cdc_payment:
            move = payment._create_cdc_journal_entry(
                ...
                label='Cheque Write off %s - %s' % (payment.memo, payment.name),
