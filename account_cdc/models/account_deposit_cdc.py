...
class AccountDepositCdc(models.Model):
    _name = 'account.deposit.cdc'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _description = 'Account Deposit CDC'
    ...
    payment_ids = fields.One2many(
        ...
        inverse_name='deposit_cdc_id',
        string='CDC Receivable',
        check_company=True,
        domain="[('is_cdc_payment','=', True),('payment_type','=', 'inbound'),"
               "'&',('deposit_cdc_id','=', False),"
               "('cdc_state','in', ['registered'])]"
    ) # "('is_internal_transfer','=', False),"  : remove this as odoo18 don't have this field
    ...
    def create(self, vals):
        ...
        if vals.get('name', _('New')) == _('New'):
            ...
            vals['name'] = \
                self.env['ir.sequence'].next_by_code('account.deposit.cdc', sequence_date=seq_date) or _('New')
        return super(AccountDepositCdc, self).create(vals)
    ...
    def action_deposit(self):
        ...
        for record in self:
            ...
            record.payment_ids.cdc_state = 'deposit'
