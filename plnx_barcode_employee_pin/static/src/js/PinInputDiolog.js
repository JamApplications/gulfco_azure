...
export class pinDialog extends Component {
    static template = "plnx_barcode_employee_pin.pinDialog";
...
//        this.env.dialogData.dismiss = () => this._dismiss();
    ...
    async _cancel() {
     ...
     async _confirm() {
        return this.props.confirm(this.input.el.value);
    }
